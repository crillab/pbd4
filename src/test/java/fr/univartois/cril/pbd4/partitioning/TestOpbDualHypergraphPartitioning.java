...
/**
 * The TestOpbDualHypergraphPartitioning is a JUnit test case for testing the
 * partitioning of the dual hypergraph of a pseudo-Boolean formula, and
 * especially the computation of a cutset.
 *
