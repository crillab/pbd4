...
/**
 * The TestCnfDualHypergraphPartitioning is a JUnit test case for testing the
 * partitioning of the dual hypergraph of a CNF formula, and especially the
 * computation of a cutset.
 *
...
public final class TestCnfDualHypergraphPartitioning extends AbstractTestDualHypergraphPartitioning {
    ...
    public void testExample2() {
        assertHasCutset(bcp(readCnf("example-2.cnf")), 1, 2);
    }
